...
public class Slider {
    public static void main(String[] args) {
        ...
        act.dragAndDropBy(min_slider,100,0).perform(); // source, xOffset, yOffset

        System.out.println("Location of the min slider : " +min_slider.getLocation());  // (158,251)
        System.out.println("Height & width of the element : " +min_slider.getSize());   // (22,21)
